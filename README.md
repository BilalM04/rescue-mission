...
# [A2] Island ca.mcmaster.se2aa4.island.team107.Explorer
...
- The `ca.mcmaster.se2aa4.island.team107.Explorer` class implements the command center, used to compete with the others. (XXX being the team identifier)
